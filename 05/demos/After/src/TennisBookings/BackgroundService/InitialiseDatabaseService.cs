...
public class InitialiseDatabaseService : IHostedService
{
	...
	public InitialiseDatabaseService(IServiceScopeFactory scopeFactory) =>
	...
	public async Task StartAsync(CancellationToken cancellationToken)
	{
		...
		var dbContext = serviceScope.ServiceProvider
			.GetRequiredService<TennisBookingsDbContext>();

		dbContext.Database.EnsureCreated();

		var userManager = serviceScope.ServiceProvider
			.GetRequiredService<UserManager<TennisBookingsUser>>();
		var roleManager = serviceScope.ServiceProvider
			.GetRequiredService<RoleManager<TennisBookingsRole>>();
